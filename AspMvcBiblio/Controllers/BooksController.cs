...
namespace AspMvcBiblio.Controllers
{
	public class BooksController : Controller
	{
		...
		public BooksController(IBookRepository repository, IAuthorRepository authorRepository, IThemeRepository themeRepository,
		...
		public async Task<IActionResult> Create(BookCreateModel model)
		{
			...
			if (ModelState.IsValid)
			{
				...
				var keyword = await _keywordRepository.GetById(model.KeywordId);
				if (author == null || theme == null || keyword == null)
				{ return NotFound(); }
				...
				var newbook = new Book()
				{
					ISBN = model.ISBN!,
					Title = model.Title!,
                    CopiesNumber = model.CopiesNumber!
                };
